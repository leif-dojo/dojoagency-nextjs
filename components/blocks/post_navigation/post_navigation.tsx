  ...
  <section className="w-full bg-white text-slate">
    <div className='w-full flex flex-nowrap px-100 py-100'>
      <div className='flex w-1/2 justify-items-start'>
        { block.back_link && (
          <a href={`${block.back_link}`} className="inline-flex mr-auto text-blue" aria-label="Previous">
      ...
      <div className='flex w-1/2 justify-items-end'>
        { block.forward_link && (
          <a  href={`${block.forward_link}`} className="inline-flex ml-auto text-blue" aria-label="Next">
