...
export async function generateMetadata(
  ...
  jsonLd_WebPage = {
    ...
    "@type": "WebPage",
    "name": "Dojo Agency",
    "url": 'https://www.dojoagency.com/core-stories/' + slug,
    ...
    "breadcrumb": {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Vans",
          "item": "https://www.dojoagency.com/core-stories"
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": data.entry.title,
          "item": `https://www.dojoagency.com/core-stories/${slug}`
        }
      ].filter(Boolean),
    }
  }
  return {
    ...
    alternates: {
      canonical: data.entry.canonical || "https://www.dojoagency.com/core-stories/" + slug,
    },
    openGraph: {
      url: '/core-stories/' + slug,
      title: data.entry.meta_title ? data.entry.meta_title : data.entry.title,
      description: data.entry.meta_description ? data.entry.meta_description : '',
