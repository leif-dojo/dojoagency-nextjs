...
export async function generateMetadata(
  ...
  jsonLd_WebPage = {
    ...
    "@type": "WebPage",
    "name": "Dojo Agency",
    "url": 'https://www.dojoagency.com/project/' + slug,
    ...
    "breadcrumb": {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Vans",
          "item": "https://www.dojoagency.com/project"
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": data.entry.title,
          "item": `https://www.dojoagency.com/project/${slug}`
        }
      ].filter(Boolean),
    }
  }
  ...
  return {
    ...
    alternates: {
      canonical: data.entry.canonical || "https://www.dojoagency.com/project/" + slug,
    },
    openGraph: {
      url: 'project/' + slug,
      title: data.entry.meta_title ? data.entry.meta_title : data.entry.title,
